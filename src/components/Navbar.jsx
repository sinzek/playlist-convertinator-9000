...
export default function Navbar() {
	...
	const [activeState, setActiveState] = useState(""); // Initialize active state

	useEffect(() => {
		setActiveState(location.pathname); // Set active state to current path
	}, [location.pathname]);
	...
	return (
		<>
			<header className="flex items-stretch items-center justify-center w-full pt-2 pb-5">
				...
				<div className="hidden sm:flex bg-base-200 rounded-box w-[3.5rem] ml-2 items-center justify-center">
					{" "}
					{/* on larger screns */}
