			...
			<div className="flex flex-col items-center mx-5">
				...
				<div className="card h-auto bg-base-100 border-1 border-primary/5 border-t-0 rounded-box flex-grow w-full lg:w-[40%] md:w-[50%] p-5 justify-center items-center text-center shadow-lg">
					<div className={`w-full items-center justify-center`}>
						...
						<form
							className="flex flex-col w-full items-left justify-center"
						...
						>
							...
							<div
								role="alert"
								className={`flex w-full items-left text-left alert transition-all ease-in-out duration-150 ${
									emailFocus && email && !validEmail
										? "mt-2"
										: "h-0 p-0 border-0 mt-0 overflow-hidden"
								}`}
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
							...
							<label
								className="input input-bordered w-full flex items-center gap-2 mt-2 shadow-inner bg-base-200 focus-within:bg-base-100"
