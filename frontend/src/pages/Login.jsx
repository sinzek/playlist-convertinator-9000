        ...
        <>
          <div className="flex flex-col items-center mx-5">
            <div role="tablist" className="tabs tabs-lifted px-10" id="tab-list">
              <a role="tab" className={`tab text-xl font-bold h-[3rem] ${ActiveTab === 'login' ? 'tab-active text-primary' : 'bg-base-300'}`} onClick={() => setActiveTab('login')}>Log in</a>
              <a role="tab" className={`tab text-xl font-bold h-[3rem] ${ActiveTab === 'create-acc' ? 'tab-active text-primary' : 'bg-base-300'}`} onClick={() => setActiveTab('create-acc')}>Create account</a>
            </div>
            <div className="card h-auto bg-base-100 border-1 border-primary/5 border-t-0 rounded-box flex-grow w-full lg:w-[40%] md:w-[50%] p-5 justify-center items-center text-center shadow-lg" id="login-card">

              {/* ============================================ */}
              {/* ================== LOG IN ================== */}
              {/* ============================================ */}

              <div className={`w-full items-center justify-center ${ActiveTab === 'login' ? '' : 'hidden'}`}>
              ...
              <div className={`w-full items-center justify-center ${ActiveTab === 'create-acc' ? '' : 'hidden'}`}>
                ...
                <form className="flex flex-col w-full items-left justify-center">
                  ...
                  <label className="input input-bordered w-full flex items-center gap-2 mt-2 shadow-inner bg-base-200 focus-within:bg-base-100" htmlFor="password">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 16 16"
                      fill="currentColor"
